   ...
   class eosio_codegen_visitor : public RecursiveASTVisitor<eosio_codegen_visitor>, public generation_utils {
      ...
      public:
         ...
         virtual void HandleTranslationUnit(ASTContext &Context) {
            ...
            if (main_fe) {
               auto fid = src_mgr.getOrCreateFileID(f_mgr.getFile(main_file).get(), SrcMgr::CharacteristicKind::C_User);
               ...
               try {
                  ...
                  std::ofstream out(std::string(res.c_str())+"/"+llvm::sys::path::filename(main_fe.get()->getName()).str());
      ...
      public:
         virtual std::unique_ptr<ASTConsumer> CreateASTConsumer(CompilerInstance &CI, StringRef file) {
            ...
            return _make_unique<eosio_codegen_consumer>(&CI, file.str());
         }
   };
